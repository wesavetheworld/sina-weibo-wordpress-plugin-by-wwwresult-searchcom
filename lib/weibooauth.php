...
/*
 *
 * Basic lib to work with Weibo's OAuth . This is untested and should not
 * be used in production code. Weibo's beta could change at anytime.
 *
 * Code based on:
...
class WeiboOAuth {
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'WeiboOAuth v0.2.0-beta2';
